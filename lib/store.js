...
const { initAuthCreds, BufferJSON, proto } = (await import('@chatunity/baileys')).default;
...
/**
 * @param {import('@chatunity/baileys').WASocket | import('@chatunity/baileys').WALegacySocket}
 */
function bind(conn) {
  if (!conn.ev) {
   ...
   * @param {import('@chatunity/baileys').Contact[]|{contacts:import('@chatunity/baileys').Contact[]}} contacts
   */
